...
package com.studio1r.admsandbox;
...
public class MainActivity extends Activity
{
    ...
    /**
     * Create a {@link android.content.BroadcastReceiver} for listening to messages from ADM.
     * 
     * @param msgKey String to access message field from data JSON.
     * @param timeKey String to access timeStamp field from data JSON.
     * @return {@link android.content.BroadcastReceiver} for listening to messages from ADM.
     */
